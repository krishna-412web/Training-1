...
<cfoutput>
	<b>cfinvoke</b> function used to call <b>multiply(1,2)</b> to get result <b>#var#</b><br>

	<cfset var1=mycomp.multiply(1,2,3)>
	<b>cfobject</b> function used to call <b>multiply(1,2,3)</b> to get result <b>#var1#</b><br>

	<cfset var2=obj1.multiply(1,2,3,4)>
	<b>createObject()</b> function used to call <b>multiply(1,2,3,4)</b> to get result <b>#var2#</b><br>
</cfoutput>
