...
<cfif arrayLen(successArray) GT 0>
	<cfset successStartRow = ArrayLen(errorArray)+1>
	<cfloop array="#successArray#" index="j" item="i">
		<cfset spreadsheetSetCellValue(spreadsheetObj, "#i.titleName#", j+successStartRow, 1)>
		<cfset spreadsheetSetCellValue(spreadsheetObj, "#i.firstname#", j+successStartRow, 2)>
		<cfset spreadsheetSetCellValue(spreadsheetObj, "#i.lastname#", j+successStartRow, 3)>
		<cfset spreadsheetSetCellValue(spreadsheetObj, "#i.genderName#", j+successStartRow, 4)>
		<cfset spreadsheetSetCellValue(spreadsheetObj, "#i.dob#", j+successStartRow, 5)>
		<cfset spreadsheetSetCellValue(spreadsheetObj, "#i.email#", j+successStartRow, 6)>
		<cfset spreadsheetSetCellValue(spreadsheetObj, "#i.phone#", j+successStartRow, 7)>
		<cfset spreadsheetSetCellValue(spreadsheetObj, "#i.hobbieNames#", j+successStartRow, 8)>
		<cfset spreadsheetSetCellValue(spreadsheetObj, "#i.houseName#", j+successStartRow, 9)>
		<cfset spreadsheetSetCellValue(spreadsheetObj, "#i.street#", j+successStartRow, 10)>
		<cfset spreadsheetSetCellValue(spreadsheetObj, "#i.city#", j+successStartRow, 11)>
		<cfset spreadsheetSetCellValue(spreadsheetObj, "#i.state#", j+successStartRow, 12)>
		<cfset spreadsheetSetCellValue(spreadsheetObj, "#i.pincode#", j+successStartRow, 13)>
		<cfset spreadsheetSetCellValue(spreadsheetObj, "#i.RESULT#", j+successStartRow, 14)>
		<cfset SpreadsheetSetRowHeight(spreadsheetObj,j+successStartRow,20)>
	</cfloop>
</cfif>

<cfloop from="1" to="#3+ArrayLen(errorArray)+ArrayLen(successArray)#" index="i">
	<cfif i%2 NEQ 0>
